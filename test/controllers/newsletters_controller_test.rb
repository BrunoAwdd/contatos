...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { html_message: @newsletter.html_message, status: @newsletter.status, subject: @newsletter.subject, text_message: @newsletter.text_message }
    end
  ...
  test "should update newsletter" do
    patch :update, id: @newsletter, newsletter: { html_message: @newsletter.html_message, status: @newsletter.status, subject: @newsletter.subject, text_message: @newsletter.text_message }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
