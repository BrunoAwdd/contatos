class NotesController < ApplicationController
  ...
  def create
    @contato = Contato.find(params[:contato_id])
    @note = @contato.notes.create(note_params)
  ...
  def update
    respond_to do |format|
      if @note.update(note_params)
        format.html { redirect_to @note.contato, notice: 'Note was successfully updated.' }
  ...
  private
    ...
    def note_params
      params.require(:note).permit(:observacao, :contato_id)
    end
end
